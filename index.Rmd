...
--
- **Conclusion**: we actually need a lot of math to do a math with only additions only <i class="fa fa-long-arrow-right" aria-hidden="true"></i> the era of algorithms
...
- only multiplication and additions... so algorithm!
